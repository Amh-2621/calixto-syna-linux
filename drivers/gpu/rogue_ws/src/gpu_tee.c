...
int getValueFromTA(int cmdId, int *size)
{
	int result;
...
int setFwParams(int cmdId, IMG_UINT64 a, IMG_UINT64 b, IMG_UINT32 c, IMG_UINT32 d)
{
	int result;
	struct tee_ioctl_invoke_arg arg;
	struct tee_param param[4];
...
int setFwPageTableAddr(int cmdId, IMG_UINT64 a, IMG_UINT64 b, IMG_UINT64 c, IMG_UINT64 d)
{
	int result;
	struct tee_ioctl_invoke_arg arg;
	struct tee_param param[4];
